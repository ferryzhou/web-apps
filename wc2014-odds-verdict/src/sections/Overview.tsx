        ...
        <div className="container relative z-10 max-w-read px-6 pb-24 pt-36 md:pt-44">
          <Reveal>
            <div className="flex items-center gap-3">
              ...
              <span className="kicker text-gold-deep">A study of prediction · FIFA World Cup 2014</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-prose text-lg leading-relaxed text-ink-muted">
              ...
              <span className="tnum text-ink">{count}</span> matches of the 2014 World Cup,
        ...
        <div className="container max-w-read">
          ...
          <Reveal delay={0.05}>
            <div className="mt-8 max-w-prose space-y-5 text-[1.05rem] leading-relaxed text-ink-soft">
              ...
              <p>
                On the whole, the market was bimodal. Strong favourites delivered — the
                70–80% band converting at a perfect 100%, the 50–60% band at 75% — and the
                Brier score of{" "}
                <span className="tnum font-semibold text-ink">
                ...
                sit in the range expected of a competent forecast. But the tightest calls
                collapsed entirely: where the favourite was priced barely ahead, every
                match went against it. Spain's demolition by the Netherlands and Brazil's
                Mineirazo against Germany frame the drama —{" "}
              ...
              <p>
                The headline lesson is a tournament of two markets. Above 50% the market
                was sharp; below it, a graveyard. Aggregated across the tournament,
                favourites won slightly more often than their price implied — the classic
                favourite-longshot signature — but the{" "}
                <span className="tnum font-semibold text-ink">+7.3%</span> bias masks the
                violence: favourites won, but only when the market was confident. Where
                the favourite was priced barely ahead, the market collapsed on its
                tightest calls. The Calibration Lab lays the split bare.
              </p>
            </div>
          </Reveal>
        </div>
