// Strategy backtesting for the WC2014 odds study.
//
...
export const STRATEGIES: Strategy[] = [
  {
    ...
    insight:
      "Establishes the floor. Favourites won 56.3% of the time — barely clearing their odds for a near-breakeven result. The aggregate hides a violent split by confidence band.",
  ...
  },
  {
    ...
    insight:
      "Knockout accuracy was mixed — the Round of 16 was sharp at 75%, but both semifinals and the final went against the favourite. The late knockouts were a graveyard.",
  ...
  },
  {
    ...
    insight:
      "Above 50% the favourite won 75% of the time. The 50–60% band was the market's best call, and filtering out the coin-flips isolated where the market was genuinely sharp.",
  ...
  },
  {
    ...
    insight:
      "The 70–80% band converted at a perfect 100% and the 60–70% band at 70% — confidence begets accuracy. Only the Mineirazo and a few group upsets broke the pattern.",
  ...
  },
  {
    ...
    insight:
      "In the 40–50% bucket favourites won 64% of the time, but the 33–40% bucket was a total wipeout at 0%. Filtering only the 40–50% band still left the lethal tightest calls in play.",
    decide: (a) =>
  ...
  },
  {
    ...
    insight:
      "Two edges — knockout sharpness and the >50% calibration break — stack, but 2014's late knockouts were brutal. Seven bets qualified, five won; the two misses were the semifinal and the final.",
    decide: (a) =>
  ...
  },
  {
    ...
    insight:
      "The dead zone was lethal: the 33–40% bucket went 0 for 12, every favourite losing. Backing the draw there meant backing the wrong side of a market that collapsed on its tightest calls.",
    decide: (a) =>
