        ...
        <Reveal delay={0.15}>
          <div className="flex h-full flex-col justify-center border border-ink/15 bg-ink p-8 text-parchment">
            ...
            <p className="mt-4 font-display text-2xl font-medium leading-snug">
              A <span className="text-gold-soft">favourite-longshot</span> bias, clean
              and consistent.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-parchment/70">
              Clear favourites — priced above 50% — won markedly more often than their
              quote, the 70–80% band converting at 75% and the 50–60% band at 71%. That
              is the textbook favourite-longshot bias, and in 2018 it held across nearly
              every band: even in the tightest 33–40% matches favourites won half the
              time. The single blemish was Germany, defending champions priced as a
              strong favourite in their openers and beaten by both Mexico and South
              Korea. Netted across 64 matches, the aggregate favourite bias of{" "}
              <span className="tnum text-gold-soft">
                {biasPct >= 0 ? "+" : ""}{biasPct.toFixed(1)}%
              </span>{" "}
              is the largest of the World Cups studied — a systematic signal that only
              surfaces across many matches.
            </p>
          </div>
        </Reveal>
      </div>
