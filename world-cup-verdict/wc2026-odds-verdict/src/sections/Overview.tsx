        ...
        <div className="container relative z-10 max-w-read px-6 pb-24 pt-36 md:pt-44">
          <Reveal>
            <div className="flex items-center gap-3">
              ...
              <span className="kicker text-gold-deep">A study of prediction · FIFA World Cup 2026</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-prose text-lg leading-relaxed text-ink-muted">
              ...
              <span className="tnum text-ink">{count}</span> matches of the 2026 World Cup,
