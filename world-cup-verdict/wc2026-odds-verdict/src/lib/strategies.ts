// Strategy backtesting for the WC2026 odds study.
//
...
export const STRATEGIES: Strategy[] = [
  ...
  },
  {
    ...
    insight:
      "Every side priced above 70% converted, and the 60–70% band won at a rate well above its quote. Confidence begets accuracy here.",
