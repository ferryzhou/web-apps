        ...
        <div className="grain relative mt-10 overflow-hidden bg-ink px-8 py-10 text-parchment md:px-12">
          <div className="relative z-10">
            ...
            <p className="mt-4 max-w-prose font-display text-2xl font-medium leading-snug">
              ...
              <span className="text-pitch-soft">clear a profit</span> — the market
              under-rated favourites in 2006. The edge lives in the filters all the same.
            </p>
            ...
            <p className="mt-8 max-w-prose text-sm leading-relaxed text-parchment/60">
              ...
              64-match sample. Strategies built on a handful of bets carry wide error
              bars — a single upset swings ROI by double digits. The value-draw filter
              returned +38.9% on just nine bets, but the strong-favourite signal (33 bets,
              +27.3%) is the sturdiest edge, with skip-the-dead-zone close behind (55
              bets, +24.9%). Knockouts alone lost money. Real confidence needs hundreds of
