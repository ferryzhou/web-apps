        ...
        <div className="container relative z-10 max-w-read px-6 pb-24 pt-36 md:pt-44">
          <Reveal>
            <div className="flex items-center gap-3">
              ...
              <span className="kicker text-gold-deep">A study of prediction · FIFA World Cup 2006</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-prose text-lg leading-relaxed text-ink-muted">
              ...
              <span className="tnum text-ink">{count}</span> matches of the 2006 World Cup,
          ...
          <Reveal delay={0.05}>
            <div className="mt-8 max-w-prose space-y-5 text-[1.05rem] leading-relaxed text-ink-soft">
              <p className="dropcap">
                ...
                strong headline, and accuracy alone flatters a forecaster. The deeper
              ...
              <p>
                On the whole, the market was honest rather than heroic, and it leaned the
                right way. The favourite bias of{" "}
                <span className="tnum font-semibold text-ink">+15.2%</span> is the
                textbook favourite-longshot pattern — favourites outperformed their
                quotes, not underperformed. The Brier score of{" "}
                <span className="tnum font-semibold text-ink">
                ...
                sit in the range of a competent probability forecast, and the cracks are
                narrow: tightly-matched knockouts produced{" "}
                <span className="tnum font-semibold text-ink">{drawsCount}</span> draws —
                level at 90 minutes — and only{" "}
                <span className="tnum font-semibold text-ink">{upsetsCount}</span>{" "}
                upsets. France, the eventual runners-up, beat Spain and then Brazil;
                Italy conceded only twice all tournament.
              </p>
              <p>
                The headline lesson is a textbook favourite-longshot bias that held hard.
                Favourites priced at 60% or higher converted at 87% and 100% — heavy
                confidence was richly rewarded — and only the 40–50% dead zone, which
                won just 33%, broke the pattern. Everywhere else favourites matched or
                beat their price. The Calibration Lab lays the bias bare.
              </p>
            </div>
          </Reveal>
        </div>
