    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <ChartCard
          ...
          caption="Green bars beat the tournament average (dashed); gold bars fall below it. The group stage led at 71% accuracy; the Round of 16 held 63% despite two ties level at 90 minutes. The quarter-finals collapsed to 25% — three of four were draws at full time and Brazil fell to France — and the final, itself a draw, went against the favourite."
          delay={0}
        >
