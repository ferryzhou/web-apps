        ...
        <Reveal delay={0.15}>
          <div className="flex h-full flex-col justify-center border border-ink/15 bg-ink p-8 text-parchment">
            ...
            <p className="mt-4 font-display text-2xl font-medium leading-snug">
              A <span className="text-gold-soft">favourite-longshot</span> signature,
              broken by two upsets.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-parchment/70">
              Clear favourites — priced between 50% and 80% — won markedly more often than
              their quote, the 70–80% band converting at a perfect 100%. That is the
              textbook favourite-longshot bias: the market under-rates strong favourites.
              But two cracks break the pattern. In the tightest matches, where the
              favourite was priced barely ahead, draws and upsets piled up and these sides
              won just 37% of the time. And the single heaviest favourite of the
              tournament — Argentina at 80% in their opener — was upset by Saudi Arabia.
              Netted across 64 matches, the aggregate favourite bias of{" "}
