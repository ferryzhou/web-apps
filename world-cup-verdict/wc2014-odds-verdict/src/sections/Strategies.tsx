        ...
        <div className="grain relative mt-10 overflow-hidden bg-ink px-8 py-10 text-parchment md:px-12">
          <div className="relative z-10">
            ...
            <p className="mt-4 max-w-prose font-display text-2xl font-medium leading-snug">
              ...
              <span className="text-parchment/60">break even</span> — the aggregate hides a
              violent split. The edge lives in the confidence filter.
            </p>
            ...
            <p className="mt-8 max-w-prose text-sm leading-relaxed text-parchment/60">
              ...
              64-match sample. Strategies built on as few as seven bets carry wide error
              bars — a single upset swings ROI by double digits. The knockout-strong
              filter returned +11.4% on seven bets, but the strong-favourite signal (24
              bets, +16.5%) is the sturdiest edge — it isolates the confident half of the
              market. The value-draw play collapsed (−53.9%) because the dead zone was a
              wipeout. Real confidence needs hundreds of matches. Treat these results as a
