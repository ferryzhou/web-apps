    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <ChartCard
          ...
          caption="Green bars beat the tournament average (dashed); gold bars fall below it. The knockouts were sharp early and brutal late — the Round of 16 was clean at 75%, but both semifinals and the final went against the favourite. The group stage was where the tightest calls collapsed."
          delay={0}
        >
