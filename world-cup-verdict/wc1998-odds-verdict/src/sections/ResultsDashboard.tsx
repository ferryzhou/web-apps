    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <ChartCard
          ...
          caption="Green bars beat the tournament average (dashed); gold bars fall below it. The group stage settled at 60% across forty-eight matches and twenty draws. The Round of 16 sharpened to 75%, but the quarter-finals fell to 50% — France and Italy traded blanks in a 0-0 stalemate, and Croatia swept a favoured Germany aside 0-3. One semi-final held; the third-place match and the final both went against the favourite, leaving those last two stages at zero."
          delay={0}
        >
