        ...
        <div className="container relative z-10 max-w-read px-6 pb-24 pt-36 md:pt-44">
          <Reveal>
            <div className="flex items-center gap-3">
              ...
              <span className="kicker text-gold-deep">A study of prediction · FIFA World Cup 1998</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-prose text-lg leading-relaxed text-ink-muted">
              ...
              <span className="tnum text-ink">{count}</span> matches of the 1998 World Cup,
          ...
          <Reveal delay={0.05}>
            <div className="mt-8 max-w-prose space-y-5 text-[1.05rem] leading-relaxed text-ink-soft">
              <p className="dropcap">
                ...
                middling hit rate, and accuracy alone flatters a forecaster. The deeper
              ...
              <p>
                ...
                bias of{" "}
                <span className="tnum font-semibold text-ink">+6.0%</span> runs the right
                way — favourites outperformed their quotes, the opposite of the classic
                favourite-longshot pattern in which they underperform. The Brier score of{" "}
                <span className="tnum font-semibold text-ink">
                ...
                sit in the range of a competent probability forecast, and the cracks show
                in the middle of the ground: tightly-matched group games produced{" "}
                ...
                upsets. Spain, fancied to top their group, lost their opener to Nigeria;
                Germany, a quarter-final favourite, were taken apart 0-3 by a debut
                Croatia side.
              </p>
              <p>
                The headline lesson is that the market under-rated its favourites. They
                won more often than their price implied — a +6.0% bias — and the dividend
                concentrated at the top: favourites priced above 70% were flawless
                (100%), those above 60% near-faultless (69%), while the 40–60% middle was
                a coin-flip. France, the home side, were favourites in every match but
                the final; Brazil, the tournament favourite, could not justify theirs,
                beaten 3-0 when it mattered. The Calibration Lab lays the shape of it
                bare.
              </p>
            </div>
          </Reveal>
