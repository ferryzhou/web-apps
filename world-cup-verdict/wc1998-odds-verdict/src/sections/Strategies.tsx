        ...
        <div className="grain relative mt-10 overflow-hidden bg-ink px-8 py-10 text-parchment md:px-12">
          <div className="relative z-10">
            ...
            <p className="mt-4 max-w-prose font-display text-2xl font-medium leading-snug">
              ...
              <span className="text-pitch-soft">turn a small profit</span> — in 1998 the
              market under-rated favourites, not over-rated them. The edge still lives in
              the filters, but the floor itself held.
            </p>
            ...
            <p className="mt-8 max-w-prose text-sm leading-relaxed text-parchment/60">
              ...
              64-match sample, and strategies built on as few as six bets carry wide error
              bars — a single upset swings ROI by double digits. The knockout-strong
              filter returned +28.3% on just six bets, but the contrarian value-draw (18
              bets, +7.8%) and heavy-favourites (23 bets, +6.8%) are the sturdier edges at
              usable samples. Every strategy cleared breakeven this time — even the naive
              baseline of betting every favourite. Real confidence needs hundreds of
              matches. Treat these results as a demonstration of method, not a licence to
              print money.
            </p>
          </div>
        </div>
