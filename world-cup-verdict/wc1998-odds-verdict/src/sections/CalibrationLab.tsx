        ...
        <Reveal delay={0.15}>
          <div className="flex h-full flex-col justify-center border border-ink/15 bg-ink p-8 text-parchment">
            ...
            <p className="mt-4 font-display text-2xl font-medium leading-snug">
              The <span className="text-gold-soft">classic</span> favourite-longshot bias
              — favourites overperformed.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-parchment/70">
              Clear favourites — priced above 70% — were flawless, converting at 100%, and
              the 60–70% band won 69% of the time. The market under-rated its strongest
              sides. But the middle of the ground was a coin-flip: the 40–50% band won
              exactly 50% and the 33–40% band just 46%. Twenty draws filled the gaps
              between them. Brazil, the tournament favourite, could not hold up their end
              — beaten 3-0 by France in the final as a 2.50 chance; Germany, a 1.90
              quarter-final pick, were swept aside 0-3 by debutants Croatia. Netted across
              64 matches, the aggregate favourite bias of{" "}
              <span className="tnum text-gold-soft">
                {biasPct >= 0 ? "+" : ""}{biasPct.toFixed(1)}%
              </span>{" "}
              is positive — favourites won more often than their price implied, the
              textbook favourite-longshot bias holding where it usually does, at the short
              end.
            </p>
          </div>
        </Reveal>
