// Strategy backtesting for the WC2018 odds study.
//
...
export const STRATEGIES: Strategy[] = [
  {
    ...
    insight:
      "Establishes the floor. Favourites won 59.4% of the time and cleared their odds — the +10.9% favourite bias meant even this blunt baseline turned a profit.",
  ...
  },
  {
    ...
    insight:
      "Knockout accuracy edged the group stage (63% vs 58%) and the late rounds were clean — both semifinalists and the finalist delivered. The market sharpened when the stakes rose.",
  ...
  },
  {
    ...
    insight:
      "Above 50% the favourite won 71% of the time; the 50–60% band was the market's sweet spot. Confidence above the coin-flip line was well-placed.",
  ...
  },
  {
    ...
    insight:
      "The 70–80% band converted at 75% and the 60–70% band at 64% — heavy favourites mostly delivered, though one famous German collapse sat in this range.",
  ...
  },
  {
    ...
    insight:
      "In the 40–50% bucket favourites still won 58% of the time — better than the tournament average. Filtering this band out actually removed profitable bets in 2018.",
    decide: (a) =>
  ...
  },
  {
    ...
    insight:
      "Two independent edges — knockout sharpness and the >50% calibration break — stack cleanly. In 2018 only two bets qualified, and both won. Few bets, high conviction, wide error bars.",
    decide: (a) =>
  ...
  },
  {
    ...
    insight:
      "The dead zone produced only 5 draws from 26 matches and favourites won 58% there — backing the draw was the wrong side of a market that under-rated favourites.",
    decide: (a) =>
