        ...
        <div className="grain relative mt-10 overflow-hidden bg-ink px-8 py-10 text-parchment md:px-12">
          <div className="relative z-10">
            ...
            <p className="mt-4 max-w-prose font-display text-2xl font-medium leading-snug">
              ...
              <span className="text-pitch-soft">turn a profit</span> — the market
              under-rated favourites in aggregate. The edge lives in the filters.
            </p>
            ...
            <p className="mt-8 max-w-prose text-sm leading-relaxed text-parchment/60">
              ...
              64-match sample. Strategies built on as few as two bets carry wide error
              bars — a single upset swings ROI by double digits. The knockout-strong
              filter produced the highest return (2 bets, +52.5%), but the
              knockout-only signal (16 bets, +30.3%) is the sturdiest edge. Real
              confidence needs hundreds of matches. Treat these results as a
