    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <ChartCard
          ...
          caption="Green bars beat the tournament average (dashed); gold bars fall below it. The knockouts tell a sharper story — the Round of 16 was tidy, the quarter-finals a coin-flip, and the late rounds fell to the favourites. The group stage was where the upsets lived."
          delay={0}
        >
