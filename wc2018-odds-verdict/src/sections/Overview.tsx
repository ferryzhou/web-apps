        ...
        <div className="container relative z-10 max-w-read px-6 pb-24 pt-36 md:pt-44">
          <Reveal>
            <div className="flex items-center gap-3">
              ...
              <span className="kicker text-gold-deep">A study of prediction · FIFA World Cup 2018</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-prose text-lg leading-relaxed text-ink-muted">
              ...
              <span className="tnum text-ink">{count}</span> matches of the 2018 World Cup,
        ...
        <div className="container max-w-read">
          ...
          <Reveal delay={0.05}>
            <div className="mt-8 max-w-prose space-y-5 text-[1.05rem] leading-relaxed text-ink-soft">
              ...
              <p>
                On the whole, the market under-rated its favourites — and that is the
                headline of this tournament. Priced to win 48.5% of the time, they won
                59.4%, a favourite bias of +10.9%. Heavy favourites delivered: the 70–80%
                band converted at 75%. The Brier score of{" "}
                <span className="tnum font-semibold text-ink">
                ...
                sit in the range expected of a competent probability forecast. There were{" "}
                ...
                but they were the exception rather than the pattern.
              </p>
              <p>
                The headline lesson is a clean favourite-longshot bias, and the largest of
                the modern World Cups studied. Unlike tournaments where the bias is broken
                by upsets in the tightest matches, in 2018 favourites won more often than
                their price implied across nearly every band — even at 33–40% they won
                half the time. The exception was Germany, defending champions upset by
                Mexico and South Korea and out in the group stage, their worst campaign in
                80 years. But that was the exception, not the rule. The Calibration Lab
                lays it bare.
              </p>
            </div>
          </Reveal>
