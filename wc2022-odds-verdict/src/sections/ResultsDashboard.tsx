    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <ChartCard
          ...
          caption="Green bars beat the tournament average (dashed); gold bars fall below it. The knockouts tell a sharper, more volatile story — the Round of 16 was clean, the quarter-finals a bloodbath of upsets."
          delay={0}
        >
